...
export async function runLlmRewrite(text, effect, level, trueOriginal, respondingTo = '', recentMessages = [], ruleInstruction = '') {
    ...
    const prompt = effect.llmRewrite.promptTemplate
        ...
        .replaceAll('{{rule_instruction}}', ruleInstruction)
