...
import {
    ...
    buildChainPreservationNote, resolveGlobalAwarenessHit,
} from './pure.js';
...
export async function runLlmRewrite(text, effect, level, trueOriginal, respondingTo = '', recentMessages = [], ruleText = null) {
