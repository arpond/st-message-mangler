...
export function renderRulesPanel(effect, allTrackers = []) {
    ...
    const ruleBlocks = rules.map((rule, i) => {
        ...
        <div class="st_mangler_rule" data-rule-index="${i}">
            ...
            <label>
                Instruction text${infoIcon('Exposed to an llm-rewrite template as {{rule_instruction}} when this rule matches. Ignored by regex/drunk effects.')}
