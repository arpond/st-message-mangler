import { escapeHtmlForDisplay, resolveAwarenessCue, resolveScaleStep } from './pure.js';
...
export const EFFECT_TYPE_LABELS = { regex: 'Regex replace', drunk: 'Drunk mangle', 'llm-rewrite': 'LLM rewrite' };
