...
import { defaultEffectShape, DEFAULT_SETTINGS, migrateLegacySettings, backfillDefaults, sanitizeScaleSteps, migrateEffectDependency } from './pure.js';
...
export function getSettings() {
    ...
    for (const effect of settings.effects) {
        ...
        migrateEffectDependency(effect.trigger);
    }
    return settings;
}
